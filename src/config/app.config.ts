...
export const PLANT_CONFIG = {
  ...
  limits: {
    K: { min: -100, max: 100, default: 8.0 },
    tau: { min: 1, max: 3600, default: 60 }, // 1s a 1h
    L: { min: 0, max: 600, default: 5 },     // 0s a 10min
    T_amb: { min: -273, max: 1000, default: 25 }, // -273°C a 1000°C
  },
...
export const PRESETS = {
  ...
  plant: {
    horno_lento: {
      name: 'Horno Lento',
      description: 'Horno industrial de gran inercia',
      K: 5.0,
      tau: 120,    // 2 minutos
      L: 10,       // 10 segundos
      T_amb: 25,
    ...
    horno_medio: {
      name: 'Horno Medio',
      description: 'Horno de laboratorio típico',
      K: 8.0,
      tau: 60,     // 1 minuto
      L: 5,        // 5 segundos
      T_amb: 25,
    ...
    chiller_compacto: {
      ...
      description: 'Sistema de enfriamiento rápido',
      K: -3.0,
      tau: 45,     // 45 segundos
      L: 8,        // 8 segundos
      T_amb: 25,
